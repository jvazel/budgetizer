...
import { ITransactionDocument, TransactionModel } from './types';
...
export default mongoose.model<ITransactionDocument, TransactionModel>('Transaction', transactionSchema);
