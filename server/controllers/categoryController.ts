...
// @access  Private
export const getCategories = async (req: AppRequest, res: AppResponse) => {
  try {
...
// @access  Private
export const createCategory = async (req: AppRequest, res: AppResponse) => {
...
// @access  Private
export const updateCategory = async (req: AppRequest, res: AppResponse) => {
  try {
...
// @access  Private
export const deleteCategory = async (req: AppRequest, res: AppResponse) => {
  try {
