 ...
 */
export const getDaysRemaining = (today = new Date()) => {
 ...
 */
export const getTargetVelocity = (remainingBudget, daysRemaining) => {
 ...
 */
export const getActualVelocity = (totalSpent, daysCount) => {
 ...
 */
export const getDepletionDate = (remainingBudget, actualVelocity, today = new Date()) => {
